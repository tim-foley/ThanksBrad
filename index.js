...
function determineMessage(event){
    ...
    const SPENCER_MESSAGES = [
		...
		`Do your neighbors files a noise complaint every time your breathe?`,
    ...
    const WEATHER_MESSAGES = [
        `Why don't you just go outside and check for yourself?`,
		`You know, you could just check your phone.`,
		`Why don't you just check the weather channel?`,
		`How would I know?  I'm a bot not a meteorologist!`,
		`Looks like it's raining.  Not here, but somewhere.`,
		`I hope your brought a sweater...`,
		`Ugghhh... enough smalltalk.`
	...
	else if (IS_WEATHER_MESSAGE){
        listToUse = WEATHER_MESSAGES;
    }
